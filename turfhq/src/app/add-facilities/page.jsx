        ...
        <div className="min-h-screen bg-white py-12 px-4 sm:px-6 lg:px-8 flex justify-center items-center">
            <div className="w-full max-w-4xl">
                <div className="mb-6 px-2 flex justify-center flex-col items-center">
                    <h1 className="text-2xl font-bold text-black">Add New Facility</h1>
                    <p className="text-sm text-gray-500 mt-1">List your turf</p>
                </div>
                    ...
                    <Form className="flex flex-col gap-6" onSubmit={onSubmit}>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="flex flex-col gap-1.5">
                                ...
                                <div className="relative">
                                    <select
                                        ...
                                        name="sportType"
                                        defaultValue=""
                                        className="w-full px-4 py-3 h-11.5 rounded-xl border border-gray-200 text-sm text-gray-600 cursor-pointer"
                                    >
                            ...
                            <TextField isRequired name="pricePerHour" type="number" className="flex flex-col gap-1.5">
                                <Label className="text-[11px] font-bold text-gray-500 uppercase tracking-wider">Price Per Hour (bdt)</Label>
                                <Input
                                    placeholder="1000"
                                    className="w-full px-4 py-3 rounded-xl border border-gray-200text-sm"
                                />
                                <FieldError className="text-xs text-red-500" />
                            </TextField>

                            <TextField isRequired name="capacity" type="number" className="flex flex-col gap-1.5">
                                <Label className="text-[11px] font-bold text-gray-500 uppercase tracking-wider">Capacity (Players)</Label>
                                <Input
                                    placeholder="10"
                                    className="w-full px-4 py-3 rounded-xl border border-gray-200text-sm"
                                />
                        ...
                        <div className="flex items-end gap-2 w-full">
                            <TextField isRequired name="timeSlots" className="flex-1 flex flex-col gap-1.5">
                                <Label className="text-[11px] font-bold text-gray-500 uppercase tracking-wider">Available Time Slots</Label>
                                <Input
